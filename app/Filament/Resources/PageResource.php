...
class PageResource extends Resource
{
    ...
    {
        return parent::getEloquentQuery()->whereNotIn('type', [PageType::Services, PageType::Posts]);
    }
            ...
            ->schema([
                Section::make()->schema([
                    ...
                    Forms\Components\Select::make('type')
                        ...
                        ->options(collect(PageType::toArray())
//                            ->forget([PageType::Services->value, PageType::Posts->value])
                            ->toArray())
                        ->reactive(),
