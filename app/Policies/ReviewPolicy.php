...
class ReviewPolicy
{
    ...
    {
        return $staff->can('view_any_review');
    }

    /**
     * Determine whether the staff can view the model.
     */
    public function view(Staff $staff, Review $review): bool
    {
        return $staff->can('view_review');
    }
    ...
    {
        return $staff->can('create_review');
    }

    /**
     * Determine whether the staff can update the model.
     */
    public function update(Staff $staff, Review $review): bool
    {
        return $staff->can('update_review');
    }

    /**
     * Determine whether the staff can delete the model.
     */
    public function delete(Staff $staff, Review $review): bool
    {
        return $staff->can('delete_review');
    }
    ...
    {
        return $staff->can('delete_any_review');
    }

    /**
     * Determine whether the staff can permanently delete.
     */
    public function forceDelete(Staff $staff, Review $review): bool
    {
        return $staff->can('force_delete_review');
    }
    ...
    {
        return $staff->can('force_delete_any_review');
    }

    /**
     * Determine whether the staff can restore.
     */
    public function restore(Staff $staff, Review $review): bool
    {
        return $staff->can('restore_review');
    }
    ...
    {
        return $staff->can('restore_any_review');
    }

    /**
     * Determine whether the staff can replicate.
     */
    public function replicate(Staff $staff, Review $review): bool
    {
        return $staff->can('replicate_review');
    }
    ...
    {
        return $staff->can('reorder_review');
    }
}
