...
class DoctorPolicy
{
    ...
    {
        return $staff->can('view_any_doctor');
    }

    /**
     * Determine whether the staff can view the model.
     */
    public function view(Staff $staff, Doctor $doctor): bool
    {
        return $staff->can('view_doctor');
    }
    ...
    {
        return $staff->can('create_doctor');
    }

    /**
     * Determine whether the staff can update the model.
     */
    public function update(Staff $staff, Doctor $doctor): bool
    {
        return $staff->can('update_doctor');
    }

    /**
     * Determine whether the staff can delete the model.
     */
    public function delete(Staff $staff, Doctor $doctor): bool
    {
        return $staff->can('delete_doctor');
    }
    ...
    {
        return $staff->can('delete_any_doctor');
    }

    /**
     * Determine whether the staff can permanently delete.
     */
    public function forceDelete(Staff $staff, Doctor $doctor): bool
    {
        return $staff->can('force_delete_doctor');
    }
    ...
    {
        return $staff->can('force_delete_any_doctor');
    }

    /**
     * Determine whether the staff can restore.
     */
    public function restore(Staff $staff, Doctor $doctor): bool
    {
        return $staff->can('restore_doctor');
    }
    ...
    {
        return $staff->can('restore_any_doctor');
    }

    /**
     * Determine whether the staff can replicate.
     */
    public function replicate(Staff $staff, Doctor $doctor): bool
    {
        return $staff->can('replicate_doctor');
    }
    ...
    {
        return $staff->can('reorder_doctor');
    }
}
