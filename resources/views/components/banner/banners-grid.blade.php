                ...
                <div class="swiper-slide md:col-span-6 row-span-2 rounded-xl lg:rounded-[30px] relative overflow-hidden">
                    ...
                    @if($block->images[0]['url'])
                        <div class="px-6 md:p-0 absolute left-0 w-full md:w-auto bottom-6 md:bottom-[12%] md:left-[7%] lg:bottom-[15%]">
                            <a href="{{ city_url($block->images[0]['url']) }}" class="block text-center btn-blue-gradient font-semibold text-white rounded-lg w-full md:rounded-xl py-4 lg:py-5 md:px-10 lg:px-20 text-sm md:text-base">Записаться на прием</a>
                        </div>
                    @else
                        <div class="px-6 md:p-0 absolute left-0 w-full md:w-auto bottom-6 md:bottom-[12%] md:left-[7%] lg:bottom-[15%]">
