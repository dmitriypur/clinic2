  ...
  <div class="bg-white md:p-6">
    ...
    <div class="mt-6 h-[206px] overflow-y-auto pr-1 md:min-w-[444px]">
      <button
        ...
        :key="branch.id"
        class="relative flex w-full items-center gap-2 rounded-xl border-2 bg-white px-6 py-5 text-left mt-2 first:mt-0 before:content-none"
        :class="{
      ...
      >
        ...
        <span v-if="selectedBranchId === branch.id" class="text-interactive leading-none absolute right-2">
