<template>
  <button :class="className" aria-label="Закрыть" @click="onClick">
    ...
    <path d="M17.0527 33L1.05273 17L17.0527 1" stroke-width="2" stroke-miterlimit="10"
...
export default {
  ...
  computed: {
    className() {
      return classNames(
        'hidden lg:block',
        'appearance-none bg-transparent cursor-pointer -ml-2 mr-5 p-2 rounded-md hover:bg-surface-hovered absolute left-8 top-6 lg:-left-12 lg:top-1/2 -translate-y-1/2 z-10 group',
      )
    },
  },
