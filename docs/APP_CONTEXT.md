...
- 2026-04-09: для шагов выбора даты в `BookingWidgetV3` включён flush-режим общей модалки. В [resources/js/components/Modal/Modal.vue](/Applications/MAMP/htdocs/zrenie.clinic-7/resources/js/components/Modal/Modal.vue) добавлен prop `flushSection`, а [resources/js/components/BookingWidgetV3/BookingWidgetV3.vue](/Applications/MAMP/htdocs/zrenie.clinic-7/resources/js/components/BookingWidgetV3/BookingWidgetV3.vue) включает его только на `doctor-schedule` и `clinic-schedule`. Благодаря этому линия под заголовком и контент календарных шагов тянутся от края до края модального окна без белых боковых отступов, при этом остальные модалки и шаги сохраняют старые внутренние паддинги.
